  ...
  if (showPostOnboardingSkeleton) {
    ...
    return (
      <div className="min-h-[100dvh] bg-background flex flex-col animate-fade-in max-w-full overflow-x-hidden" style={{ paddingTop: 'calc(env(safe-area-inset-top, 0px) + 4rem)' }}>
        {/* Header with Logo */}
          <div className="fixed left-0 right-0 top-safe z-40 flex items-center justify-between px-4 pb-4 pt-4 bg-card/80 backdrop-blur">
            ...
            <div className="flex items-center gap-3">
              {/* Empty space to match Home tab layout */}
            </div>
          </div>
