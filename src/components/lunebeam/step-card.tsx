  ...
  return (
    <Card className={`relative transition-shadow hover:shadow-md ${isBlocked ? "opacity-50" : ""}`}>
      ...
      <Collapsible open={isExpanded} onOpenChange={onToggleExpand}>
        <CardHeader className="px-3 pt-1 pb-0.5">
        ...
        <CardContent className="p-0">
          <CollapsibleContent className="space-y-0 px-3 pb-2 data-[state=open]:animate-accordion-down data-[state=closed]:animate-accordion-up duration-100">
            {/* Separator */}
            ...
            {step.created_at && (
              <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground">{format(new Date(step.created_at), "MMM d, yyyy")}</p>
              </div>
            )}
          </CollapsibleContent>
        </CardContent>
