        ...
        <CardContent className="pt-6 pb-6">
          <div className="flex items-center justify-around divide-x divide-border">
            ...
            <div className="flex-1 text-center">
              <div className="text-muted-foreground text-base font-bold mb-2">Streak</div>
            ...
            {/* Completed */}
            <div className="flex-1 text-center">
              <div className="text-muted-foreground text-base font-bold mb-2">Completed</div>
            ...
            {/* Missed */}
            <div className="flex-1 text-center">
              <div className="text-muted-foreground text-base font-bold mb-2">Missed</div>
