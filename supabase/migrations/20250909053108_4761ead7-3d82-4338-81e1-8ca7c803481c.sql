-- First, let's add a policy for invitees to view their own invitations
...
ALTER VIEW public.my_received_invites SET (security_barrier = true);

-- Create RLS policy for the view
CREATE POLICY "Users can view their own received invites" 
ON public.my_received_invites 
FOR SELECT 
USING (true); -- The view already filters by auth.uid()
...
-- It should only return data needed for the acceptance process
