-- Update assign_email_and_invite function to remove passcode generation
...
BEGIN
  ...
  -- Try update existing pending/expired claim for this provisioner/individual (removed passcode)
  ...
  -- If no row updated, insert new (without passcode)
