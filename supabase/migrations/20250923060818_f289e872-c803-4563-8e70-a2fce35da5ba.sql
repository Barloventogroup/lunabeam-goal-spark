-- Remove provisional_profiles table if it exists
DROP TABLE IF EXISTS public.provisional_profiles CASCADE;

-- Simplify provision_individual_direct to just create the individual account directly
...
BEGIN
  ...
  -- Create profile (will be handled by trigger, but ensure it has the right data)
...
-- Remove the complex provision_individual_with_email function since we're simplifying
