-- Patch secure approval functions to avoid RLS delete errors and grant execute

-- 1) Approve by request_id
...
-- 2) Approve by individual_id + invitee_email
...
-- 3) Ensure authenticated users can execute these RPCs
