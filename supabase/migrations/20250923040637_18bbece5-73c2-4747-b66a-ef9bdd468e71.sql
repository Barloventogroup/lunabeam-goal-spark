-- Remove provisional system and implement direct user creation with placeholder emails

-- Drop the provisional profiles table as we won't need it anymore
DROP TABLE IF EXISTS public.provisional_profiles CASCADE;

-- Create function to provision individual with placeholder email
...
-- Create function to update user email and send invite
