...
-- Fix provisioning functions to use the extensions schema explicitly
...
-- Also update the original provision_individual function to avoid gen_salt lookup issues
...
BEGIN
  ...
  INSERT INTO auth.users (
    ...
    '00000000-0000-0000-0000-000000000000',
    _user_email,
    extensions.crypt('temp_password_' || _claim_passcode, extensions.gen_salt('bf')), -- Temporary password
